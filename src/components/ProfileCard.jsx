...
const ProfileCard = () => {
  return (
    <div className="overflow-clip relative rounded-[48px] w-[393px] h-[852px]" data-name="People Swipe (Default)">
      {/* Tab Bar */}
        ...
        <div className="flex-none rotate-[3deg]">
          <div className="bg-base-card border border-[rgba(94,94,92,0.6)] h-[305px] relative rounded-[36px] w-[254px]">
            <div className="box-border flex flex-col gap-4 h-[305px] items-center overflow-clip p-5 relative rounded-[inherit] w-[254px]">
              <div className="absolute blur-[50px] filter flex gap-[10px] items-center left-[calc(50%+0.571px)] opacity-[0.12] size-[305px] top-[1.28px] translate-x-[-50%]">
                <div className="aspect-square flex-[1_0_0] min-h-px min-w-px relative shrink-0">
                  <img alt="" className="absolute h-[150%] left-[-0.94%] max-w-none top-[-8.75%] w-full" src={assets.imgImage71} />
                </div>
              </div>
              ...
              <div className="box-border flex gap-[10px] items-center overflow-clip relative rounded-full shadow-[0px_7px_29px_0px_rgba(255,255,255,0.2)] shrink-0">
                <div className="relative shrink-0 size-[115.2px]">
                  <img alt="" className="absolute h-[150%] left-[-0.94%] max-w-none top-[-8.75%] w-full rounded-full object-cover" src={assets.imgImage71} />
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Card 2 (Middle) */}
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.06975647062063217)+(var(--transform-inner-height)*0.9975640773773193)))] items-center justify-center left-[43px] top-[166px] w-[calc(1px*((var(--transform-inner-height)*0.06975647062063217)+(var(--transform-inner-width)*0.9975640773773193)))]">
        ...
        <div className="bg-[rgba(30,30,29,0.4)] border border-primary-neutral-900 h-10 relative rounded-[24px] shrink-0 w-64">
          <div className="box-border flex gap-6 h-10 items-center overflow-clip px-3 py-0 relative rounded-[inherit] w-64">
            <div className="flex flex-[1_0_0] h-full items-center min-h-px min-w-px relative rounded-[72px] shrink-0">
              <div className="box-border flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px relative shrink-0">
                <p className="font-jakarta font-semibold leading-[1.2] text-sm text-primary-neutral-50">
                  People
                </p>
              ...
              <button className="box-border cursor-pointer flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-visible relative shrink-0 hover:opacity-80 transition-opacity">
                <p className="font-jakarta font-normal leading-[1.2] text-sm text-primary-neutral-300">
                  Request
                </p>
              </button>
            </div>
        ...
        <button className="bg-[rgba(30,30,29,0.4)] border border-primary-neutral-900 box-border flex gap-[10px] items-center justify-center p-[6px] relative rounded-full shrink-0 size-11 cursor-pointer hover:bg-[rgba(30,30,29,0.6)] transition-colors">
          <div className="overflow-clip relative rounded-[5px] shrink-0 size-[22px]">
            <div className="absolute inset-[13.54%_5.21%]">
              <img alt="" className="block max-w-none size-full" src={assets.img12} />
            </div>
          </div>
        </button>
      </div>
